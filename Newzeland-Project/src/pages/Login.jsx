      ...
      >
        <div className="absolute top-4 right-4 mb-2">
          <button
            ...
            className="text-sm px-3 py-1 border rounded  bg-red-500 hover:bg-red-600 text-white transform transition duration-200 active:scale-95"
          >
            Send Request
          </button>
          <button
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-row justify-between mt-4 text-sm text-gray-500 dark:text-gray-400">
             <Link to="/register" className="hover:underline">
              Don't have an account? Sign up
            </Link>

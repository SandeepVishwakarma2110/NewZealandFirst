                        ...
                        {r.status === "pending" && (
                          <>
                            <button
                              ...
                              className="bg-green-600 text-white px-2 py-1 rounded mr-2 transform transition duration-200 active:scale-95 "
                            >
                              Approve
                            </button>
                            <button
                              onClick={() => handleAction(r._id, "reject")}
                              className="bg-red-600 text-white px-2 py-1 rounded transform transition duration-200 active:scale-95"
                            >
                              Reject
                            </button>
                          </>
